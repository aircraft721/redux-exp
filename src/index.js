...
const expenseOne = store.dispatch(addExpense({description: 'Rent', amount: 100, createdAt: 245}));
const expenseTwo = store.dispatch(addExpense({description: 'Brunei', amount: 400, createdAt: 244}));
